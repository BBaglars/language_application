...
export default function PoemGenerate() {
  ...
  const [storyTitle, setStoryTitle] = useState('Bir Şiir');
  const [storyContent, setStoryContent] = useState('Güneş doğar, umutla başlar gün\nKuşlar uçar, gökyüzünde süzülür\nHer yeni sabah, yeni bir öykü\nHayat başlar, umutla büyür.');
          ...
          <View style={[styles.mainContainer, { paddingTop: isWeb ? 32 : 0 }]}>
            ...
            {(showSettings || isWeb) && (
              <View style={[styles.readonlyContainer, isWeb ? styles.webReadonlyContainer : styles.mobileReadonlyContainer, { backgroundColor: isDark ? 'rgba(124,58,237,0.13)' : 'rgba(124,58,237,0.06)', borderColor: isDark ? '#a78bfa' : '#7C3AED', shadowColor: isDark ? '#fbbf24' : '#7C3AED' }]}>
                ...
                <ReadonlyDropdown label="Tür" value="Şiir" />
